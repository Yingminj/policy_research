...
RUNS = {
    # checkpoint dirs, not job dirs: the two new weights are at different step counts
    # (the vqbet run was still training when this was measured).
    "vqbet_100k": J / "patch_policy_tidy_up_stationery_le_batch_success_361_2026-08-30_11-19-40-151329/run/checkpoints/100000/pretrained_model",
    "eef_200k": J / "patch_policy_tidy_up_stationery_le_batch_success_505_eef_2026-08-31_13-14-33-857400/run/checkpoints/200000/pretrained_model",
    "acteef_361": J / "act_eef_tidy_up_stationery_le_batch_success_361_eef_2026-08-26_06-10-46-561630/run/checkpoints/200000/pretrained_model",
}
